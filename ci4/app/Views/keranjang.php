    ...
    <div class="col">
            ...
            <tbody>
                <?php $no = 1; foreach($items as $key) : ?>
                    <tr>
                        ...
                        <td> 
                            <a href="<?php echo base_url('kurang_pesanan/' . $key['id']) ?>" class="btn btn-sm btn-danger mr-2"> Kurang </a>
                            <?php echo $key['quantity'] ?> 
                            <a href="<?php echo base_url('tambah_pesanan/' . $key['id']) ?>" class="btn btn-sm btn-success ml-2"> Tambah </a>
                        </td>
                        ...
                        <td> <a href="<?php echo base_url('hapus_pesanan/' . $key['id']) ?>" class="btn btn-sm btn-danger"> Hapus </a></td>
                    </tr>
                <?php endforeach; ?>
                <tr>
        ...
        <div class="form-group d-flex justify-content-end ">
            <?php if(!empty(session()->get('cart'))) : ?>
                <a href="<?php echo base_url('proses_pesan') ?>" class="btn btn-sm btn-success">Pesan</a>
            <?php else: ?>
